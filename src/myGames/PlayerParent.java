...
abstract public class PlayerParent extends Unit implements Observer
{
    ...
    int deadTime;
    GameSpace gameSpace;
    PlayerParent otherPlayerParent;
    int type;
    
    public PlayerParent(int x, int y, int imgTick, int speed, Image[] img,
    ...
    //setting up rotation booleans. These are used in rotate() to rotate the angle.
    ...
    public void setOtherPlayerParent(PlayerParent playerParent) {
        this.otherPlayerParent = playerParent;
    }

    public PlayerParent getOtherPlayerParent() {
        return otherPlayerParent;
    }
